      ...
      <div className="bg-gray-50 p-6 rounded-lg border border-gray-200 text-gray-800">
        ...
        <div className="space-y-4 text-sm">
          ...
          <div>
            ...
            <p className="mt-1 text-gray-700">
              회사는 「정보통신망 이용촉진 및 정보보호 등에 관한 법률」 제31조 제1항에 따라 만 14세 미만 아동의 개인정보를 보호하기 위하여, 회원가입 시 법정대리인의 동의를 받는 절차를 별도로 운영하지 않습니다. 이에 따라 서비스는 만 14세 이상의 사용자만이 가입하여 이용할 수 있습니다.
            </p>
          </div>
