  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-8 dark:bg-zinc-900 min-h-screen">
      <div className="relative flex items-center justify-center mb-8">
        <BackButton />
        <h1 className="text-2xl font-bold text-center dark:text-zinc-100">만 14세 이상 서비스 이용 동의</h1>
      </div>
      ...
      <div className="bg-gray-50 dark:bg-zinc-800 p-6 rounded-lg 
        ...
        <h3 className="text-lg font-semibold text-center mb-6 dark:text-zinc-100">만 14세 이상 서비스 이용 동의 (필수)</h3>
        
        <div className="space-y-4 text-sm">
          <div>
            <strong className="block font-medium dark:text-zinc-100">제1조 (목적)</strong>
            <p className="mt-1 text-gray-700 dark:text-zinc-300">
              본 동의는 PIXO(이하 '회사')가 제공하는 모든 서비스(이하 '서비스')의 회원가입 및 이용 자격을 확인하기 위한 목적으로 합니다.
            </p>
          </div>

          <div>
            <strong className="block font-medium dark:text-zinc-100">제2조 (법령 준수)</strong>
            <p className="mt-1 text-gray-700 dark:text-zinc-300">
          ...
          <div>
            <strong className="block font-medium dark:text-zinc-100">제3조 (연령 확인 및 동의)</strong>
            <ol className="list-decimal list-inside mt-1 space-y-1 text-gray-700 dark:text-zinc-300">
          ...
          <div>
            <strong className="block font-medium dark:text-zinc-100">제4조 (허위 정보 제공에 대한 책임)</strong>
            <p className="mt-1 text-gray-700 dark:text-zinc-300">
