  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-8 dark:bg-zinc-900 min-h-screen">
      <div className="relative flex items-center justify-center mb-8">
        <BackButton />
        <h1 className="text-2xl font-bold text-center dark:text-zinc-100">개인정보 처리방침</h1>
      </div>
      ...
      <div className="bg-gray-50 dark:bg-zinc-800 p-6 rounded-lg 
        ...
        <h3 className="text-lg font-semibold text-center mb-6 dark:text-zinc-100">개인정보 처리방침 (필수)</h3>
        ...
        <div className="space-y-6 text-sm">
          ...
          <div>
            <strong className="block font-medium text-base mb-2 dark:text-zinc-100">제1조 (개인정보의 수집 항목 및 이용 목적)</strong>
            <p className="mb-2">
          ...
          <div>
            <strong className="block font-medium text-base mb-2 dark:text-zinc-100">제2조 (개인정보의 처리 및 보유 기간)</strong>
            <p className="mb-2">
          ...
          <div>
            <strong className="block font-medium text-base mb-2 dark:text-zinc-100">제3조 (개인정보의 파기절차 및 방법)</strong>
             <ul className="list-disc list-inside space-y-1 pl-4">
          ...
          <div>
            <strong className="block font-medium text-base mb-2 dark:text-zinc-100">제4조 (개인정보의 제3자 제공에 관한 사항)</strong>
            <p className="mb-2">
              회사는 정보주체의 동의, 법률의 특별한 규정 등 개인정보 보호법 제17조 및 제18조에 해당하는 경우에만 개인정보를 제3자에게 제공합니다. 회사는 다음과 같이 개인정보를 제3자에게 제공하고 있습니다.
            </p>
            <div className="overflow-x-auto">
              <table className="min-w-full border dark:border-zinc-600 text-center">
                <thead className="bg-gray-200 dark:bg-zinc-700">
                  <tr>
                    <th className="p-2 border dark:border-zinc-600 dark:text-zinc-100">제공받는 자</th>
                    <th className="p-2 border dark:border-zinc-600 dark:text-zinc-100">제공 목적</th>
                    <th className="p-2 border dark:border-zinc-600 dark:text-zinc-100">제공 항목</th>
                    <th className="p-2 border dark:border-zinc-600 dark:text-zinc-100">보유 및 이용기간</th>
                  </tr>
                </thead>
                <tbody>
                  <tr>
                    <td className="p-2 border dark:border-zinc-600">(주)누리고</td>
                    <td className="p-2 border dark:border-zinc-600">휴대폰 본인 인증 문자 발송</td>
                    <td className="p-2 border dark:border-zinc-600">휴대폰 번호</td>
                    <td className="p-2 border dark:border-zinc-600">인증 완료 시 즉시 파기</td>
                  </tr>
                </tbody>
              </table>
            </div>
          ...
          <div>
            <strong className="block font-medium text-base mb-2 dark:text-zinc-100">제5조 (개인정보 처리 위탁에 관한 사항)</strong>
            <p className="mb-2">
            ...
            <div className="overflow-x-auto">
              <table className="min-w-full border dark:border-zinc-600 text-center">
                <thead className="bg-gray-200 dark:bg-zinc-700">
                  <tr>
                    <th className="p-2 border dark:border-zinc-600 dark:text-zinc-100">수탁업체</th>
                    <th className="p-2 border dark:border-zinc-600 dark:text-zinc-100">위탁업무 내용</th>
                  </tr>
                </thead>
                <tbody>
                  <tr>
                    <td className="p-2 border dark:border-zinc-600">Google Cloud Platform</td>
                    <td className="p-2 border dark:border-zinc-600">클라우드 서버 운영 및 데이터 보관</td>
                  </tr>
                  <tr>
                    <td className="p-2 border dark:border-zinc-600">(주)누리고</td>
                    <td className="p-2 border dark:border-zinc-600">SMS 발송 업무 대행</td>
                  </tr>
                  <tr>
                    <td className="p-2 border dark:border-zinc-600">Google LLC</td>
                    <td className="p-2 border dark:border-zinc-600">알림 및 문의 답변 이메일 발송</td>
                  </tr>
                </tbody>
              </table>
            </div>
          ...
          <div>
            <strong className="block font-medium text-base mb-2 dark:text-zinc-100">제6조 (정보주체와 법정대리인의 권리·의무 및 그 행사방법)</strong>
            <p>
          ...
          <div>
            <strong className="block font-medium text-base mb-2 dark:text-zinc-100">제조 (개인정보 처리방침 변경)</strong>
            <p>
