      ...
      <div className="bg-gray-50 p-6 rounded-lg border border-gray-200 text-gray-800">
        ...
        <div className="space-y-6 text-sm">
            ...
            <div className="space-y-2 pl-4">
                ...
                <p><strong>2. 이용 목적</strong></p>
                 <ul className="list-disc list-inside space-y-1">
                  ...
                  <li>서비스 제공: 콘텐츠 제공, 맞춤 서비스 제공, 본인 인증</li>
          ...
          <div>
            ...
            <p>
              회사는 원칙적으로 개인정보 수집 및 이용목적이 달성된 후에는 해당 정보를 지체 없이 파기합니다. 단, 관계 법령의 규정에 의하여 보존할 필요가 있는 경우 회사는 아래와 같이 관계 법령에서 정한 일정한 기간 동안 회원정보를 보관합니다.
            </p>
          ...
          <div>
            <strong className="block font-medium text-base mb-2">제3조 (개인정보의 파기절차 및 방법)</strong>
             <ul className="list-disc list-inside space-y-1 pl-4">
              ...
              <li><strong>파기방법:</strong> 전자적 파일 형태로 저장된 개인정보는 기록을 재생할 수 없는 기술적 방법을 사용하여 삭제하고, 종이에 출력된 개인정보는 분쇄기로 분쇄하거나 소각하여 파기합니다.</li>
            </ul>
          </div>
            
          <div>
            <strong className="block font-medium text-base mb-2">제4조 (정보주체와 법정대리인의 권리·의무 및 그 행사방법)</strong>
            <p>
          ...
          <div>
            <strong className="block font-medium text-base mb-2">제5조 (개인정보 보호책임자)</strong>
             <ul className="list-disc list-inside space-y-1 pl-4">
              <li><strong>개인정보 보호책임자:</strong> OOO</li>
              <li><strong>소속 부서:</strong> OOO팀</li>
              <li><strong>전화번호:</strong> XX-XXXX-XXXX</li>
              <li><strong>이메일:</strong> privacy@pixo.com</li>
            </ul>
          </div>

          <div>
            <strong className="block font-medium text-base mb-2">제6조 (개인정보 처리방침 변경)</strong>
            <p>
