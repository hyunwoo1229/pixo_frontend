  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-8">
      <div className="relative flex items-center justify-center mb-8">
        <BackButton />
        <h1 className="text-2xl font-bold text-center">이용약관</h1>
      </div>

      <div className="bg-gray-50 p-6 rounded-lg border border-gray-200 text-gray-800">
        <h3 className="text-lg font-semibold text-center mb-6">PIXO 서비스 이용약관 (필수)</h3>
        ...
        <div className="space-y-6 text-sm">
          ...
          <div>
            <strong className="block font-medium text-base mb-2">제1조 (목적)</strong>
            <p>
          ...
          <div>
            <strong className="block font-medium text-base mb-2">제2조 (정의)</strong>
          ...
          <div>
            <strong className="block font-medium text-base mb-2">제3조 (약관의 게시와 개정)</strong>
            <ul className="list-decimal list-inside pl-4 space-y-1">
          ...
          <div>
            <strong className="block font-medium text-base mb-2">제4조 (회원의 의무)</strong>
            <ul className="list-decimal list-inside pl-4 space-y-1">
